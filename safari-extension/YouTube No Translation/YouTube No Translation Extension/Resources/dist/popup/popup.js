 ...
 */
const titleToggle = document.getElementById('titleTranslation');
const audioToggle = document.getElementById('audioTranslation');
const audioLanguageSelect = document.getElementById('audioLanguage');
const descriptionToggle = document.getElementById('descriptionTranslation');
const subtitlesToggle = document.getElementById('subtitlesTranslation');
const subtitlesLanguageSelect = document.getElementById('subtitlesLanguage');
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        console.log('[NTM-Debug] Settings loaded - Title translation prevention is: %c%s', settings.titleTranslation ? 'color: green; font-weight: bold' : 'color: red; font-weight: bold', settings.titleTranslation ? 'ON' : 'OFF');
        console.log('[NTM-Debug] Settings loaded - Audio translation prevention is: %c%s', settings.audioTranslation ? 'color: green; font-weight: bold' : 'color: red; font-weight: bold', settings.audioTranslation ? 'ON' : 'OFF');
        console.log('[NTM-Debug] Settings loaded - Description translation prevention is: %c%s', settings.descriptionTranslation ? 'color: green; font-weight: bold' : 'color: red; font-weight: bold', settings.descriptionTranslation ? 'ON' : 'OFF');
        console.log('[NTM-Debug] Settings loaded - Subtitles translation prevention is: %c%s', settings.subtitlesTranslation ? 'color: green; font-weight: bold' : 'color: red; font-weight: bold', settings.subtitlesTranslation ? 'ON' : 'OFF');
    }
    catch (error) {
